...
const MonLesplusvendu = () => {
  ...
  const idAcheteurL = userLocal?.idpersonnelocal;

  useEffect(() => {
    axios.get(`https://localhost:7091/api/Articles/AcheteParAcheteur${idAcheteurL}`)
      .then(response => {
  ...
  //       <Typography>nombre vendue : {selectedArticle.nbrAchat}</Typography>
...
export default MonLesplusvendu;